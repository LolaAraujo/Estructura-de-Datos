#ifndef LISTDOBLELINEAL_HPP_INCLUDED
#define LISTDOBLELINEAL_HPP_INCLUDED
#include <string>
#include <iostream>
#include <exception>
#include <fstream>
...
template <class T>
Lista<T>::Node::Node() : prev(nullptr), next(nullptr) { }

template <class T>
Lista<T>::Node::Node(const T& m) : data(m), prev(nullptr), next(nullptr) { }
...
#endif // LISTDOBLELINEAL_HPP_INCLUDED
